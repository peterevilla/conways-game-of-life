...
const Rules = () => {
  return (
    <p>
      ...
      the following transitions occur:<br/><br/>
        1- Any live cell with fewer than two live
      neighbours dies, as if by underpopulation.<br/> 
      2- Any live cell with two or three
      live neighbours lives on to the next generation.<br/> 
      3- Any live cell with more
      than three live neighbours dies, as if by overpopulation.<br/>
      4-  Any dead cell
      with exactly three live neighbours becomes a live cell, as if by
      reproduction.<br/><br/>
      These rules, which compare the behavior of the automaton to
      real life, can be condensed into the following: Any live cell with two or
      three live neighbours survives. Any dead cell with three live neighbours
